...
public class InitializerViewModel extends ViewModel {
    ...
    public static final ViewModelInitializer<InitializerViewModel> initializer = new ViewModelInitializer<>(InitializerViewModel.class, creationExtras -> new InitializerViewModel(ShoppingRepository.getShoppingRepository(), ShoppingServiceRepository.getShoppingServiceRepository(), SharedRepository.getSharedRepository()));
    ...
    public void setOldLoggedUser(User user) {
        shoppingRepository.setOldloggedUser(user);
    }

    public User getOldLoggedUser() {
        return shoppingRepository.getOldloggedUser();
    }
